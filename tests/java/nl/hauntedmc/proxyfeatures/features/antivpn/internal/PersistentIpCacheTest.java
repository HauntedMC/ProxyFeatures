...
class PersistentIpCacheTest {
    ...
    void nullResultSkipPersistAndMaintenanceOperationsWork() {
        ...
        assertDoesNotThrow(() -> ctx.cache.invalidate("12.12.12.12"));
        ...
        assertDoesNotThrow(() -> ctx.cache.invalidate("13.13.13.13"));
        assertDoesNotThrow(() -> ctx.cache.invalidate(null));
        ...
        assertDoesNotThrow(ctx.cache::clearAll);
        assertDoesNotThrow(ctx.cache::close);
    }
