...
class ResourceHandlerTest {
    ...
    void ensureAndSaveErrorBranchesAreHandled() throws Exception {
        ...
        ResourceHandler blocked = new ResourceHandler(plugin, "blocked/child.yml");
        assertNotNull(blocked.getConfig());
        assertFalse(Files.exists(tempDir.resolve("blocked/child.yml")));
        ...
        handler.save();
        assertEquals(1, handler.getConfig().node("v").getInt());
    }
