...
public class ChatChannelHandler {
    ...
    public ChatChannelHandler(StaffChat feature) {
        ...
        channels.add(new ChatChannel("staff", staffPrefix, "proxyfeatures.feature.staffchat.staff", "staffchat.staff_format"));

        String teamPrefix = (String) feature.getConfigHandler().getSetting("team_prefix");
        channels.add(new ChatChannel("team", teamPrefix, "proxyfeatures.feature.staffchat.team", "staffchat.team_format"));

        String adminPrefix = (String) feature.getConfigHandler().getSetting("admin_prefix");
        channels.add(new ChatChannel("admin", adminPrefix, "proxyfeatures.feature.staffchat.admin", "staffchat.admin_format"));
