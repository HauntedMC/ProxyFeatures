...
public class TextCommands extends VelocityBaseFeature<Meta> {
    ...
    public ConfigMap getDefaultConfig() {
        ...
        defaults.put("commands", new LinkedHashMap<>());
        return defaults;
    }
    ...
    private void initializeTextCommands() {
        ...
        for (Map.Entry<String, nl.hauntedmc.proxyfeatures.api.io.config.ConfigNode> entry : commandNodes.entrySet()) {
            ...
            Map<String, String> configuredPlaceholders = node.get("placeholders").mapValues(String.class);
            Map<String, String> placeholders = configuredPlaceholders == null
                    ? new HashMap<>()
                    : new HashMap<>(configuredPlaceholders);
