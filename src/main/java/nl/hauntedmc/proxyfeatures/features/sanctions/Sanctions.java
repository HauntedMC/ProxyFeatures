...
public class Sanctions extends VelocityBaseFeature<Meta> {
    ...
    public Sanctions(ProxyFeatures plugin) { super(plugin, new Meta()); }
    ...
    public ConfigMap getDefaultConfig() {
        ...
        cfg.put("discordWebhookURL", "https://discordhook.url");
        return cfg;
    }
    ...
    public MessageMap getDefaultMessages() {
        ...
        m.add("sanctions.invalid_length", "&8&l[&c&lSanctions&8&l]&r &cOngeldige lengte. Gebruik &f<Nd>&c of &fP&c voor permanent.");
        ...
        m.add("sanctions.perm_block",
                "&8&l[&c&lSanctions&8&l]&r &cAlleen hogere staffleden mogen permanente sancties (ban/mute) uitvoeren.");
        ...
        m.add("sanctions.usage.sactionlist",
                "&8&l[&c&lSanctions&8&l]&r &eGebruik: &f/sactionlist <naam> <all|active>");

        // Not currently sanctioned
        m.add("sanctions.not_banned", "&8&l[&c&lSanctions&8&l]&r &cDeze speler is momenteel niet verbannen.");
        m.add("sanctions.not_banned", "&8&l[&c&lSanctions&8&l]&r &cDit IP-Adres is momenteel niet verbannen.");
        ...
        m.add("sanctions.notify.muted.temp",
                "&eJe bent gemute {duration}. &7Reden: &f{reason}");
        m.add("sanctions.notify.muted.perm",
                "&eJe bent &lpermanent &r&egemute. &7Reden: &f{reason}");
        m.add("sanctions.notify.warn",
                "&eJe bent gewaarschuwd. &7Reden:  &e{reason}");
        m.add("sanctions.notify.kick",
                "&eJe bent gekickt. &7Reden: &f{reason}");

        // Disconnect messages
        m.add("sanctions.disconnect.banned.temp",
                "&cJe bent verbannen {duration}.\n&7Reden: &f{reason}\n&7Appeal: &fcontacteer de staff.");
        ...
        m.add("sanctions.chat_blocked",
                "&cJe bent gemute en kunt niet chatten. &7Resterende mute tijd: &f{remaining}");
    ...
    public SanctionsService getService() { return service; }
    public ServiceLookup getServiceLookup() { return serviceLookup; }
